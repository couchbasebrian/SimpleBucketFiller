...
public class SimpleBucketFillerAndRemover {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < NUMDOCUMENTS; i++) {
			...
			try {
				...
				removeExceptionCount++;
			}
			
			if ((i % 100) == 0) {
				System.out.println("Removing: Document " + i);
			}
			
		} // remove() loop

		System.out.println("Done.  Successfully removed:         " + removeSuccessCount + " documents.");
		System.out.println("Number of exceptions during removal: " + removeExceptionCount + " documents.");

	} // main

} // SimpleBucketFillerAndRemover
